...
const ENVELOPE_SCHEMA_HINT = [
  ...
  '- plan_draft: {"productId":"string","productName":"string","startDate":"YYYY-MM-DD","endDate":"YYYY-MM-DD","days":1,"weeks":1,"phases":[{"name":"string","order":1,"estimatedDays":1,"tasks":[{"title":"string","roleRequired":"string","requiredHeadcount":1,"weight":1,"instructions":"string","startDate":"YYYY-MM-DDTHH:mm:ssZ","dueDate":"YYYY-MM-DDTHH:mm:ssZ","assignedStaffProfileIds":[]}]}],"warnings":[{"code":"string","message":"string"}]}',
