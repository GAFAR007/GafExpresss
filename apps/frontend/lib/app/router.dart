  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          final emailParam = state.uri.queryParameters['email'];
          AppDebug.log("ROUTER", "-> /forgot-password");
          return ForgotPasswordScreen(initialEmail: emailParam);
        },
      ),
      GoRoute(
        path: chatInboxRoute,
      ...
      GoRoute(
        path: productionPlanArchiveRoute,
        builder: (context, state) {
          AppDebug.log("ROUTER", _routeProductionArchiveLog);
          return const BusinessThemeWrapper(
            child: ProductionPlanArchiveScreen(),
          );
        },
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        redirect: (context, state) {
          ...
          return productionPlanCreateRoute;
        },
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return BusinessThemeWrapper(
            child: ProductionPlanWorkspaceScreen(planId: planId),
          );
        },
      ),
      GoRoute(
