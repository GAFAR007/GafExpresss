    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          const BusinessProfileAction(logTag: "BUSINESS_ORDERS"),
        ],
      ),
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          // WHY: Central refresh keeps business data in sync across screens.
          await AppRefresh.refreshApp(ref: ref, source: "business_orders_pull");
        },
              ...
              children: [
                ...
                _StatusBadgesRow(
                  ...
                  onTap: (value) {
                    ...
                    ref.read(businessOrderStatusFilterProvider.notifier).state =
                        next;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _MetaChip(label: "Items", value: "$itemCount"),
                const SizedBox(width: 8),
                _MetaChip(
                  label: "Total",
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  _AnalyticsTile(label: "Revenue", value: revenue),
                ],
              ),
            ],
          ),
    ...
    return summaryAsync.when(
      data: (summary) {
        final entries = <Map<String, dynamic>>[
          ...
          {
            "status": "pending",
            "count": summary.ordersByStatus["pending"] ?? 0,
          },
